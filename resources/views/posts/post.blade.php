                        ...
                        @endif
                            <form class="form-horizontal" method="POST" action="{{ url('/addPost') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="post_body" rows="7" type="post_body" class="form-control" name="post_body" value="{{ old('post_body') }}" required></textarea>
                                ...
                                <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                                    <label for="post_title" class="col-md-4 control-label">Category</label>

                                    <div class="col-md-6">
                                        <select id="category_id" type="category_id" class="form-control" name="category_id" value="{{ old('category_id') }}" required autofocus>
